...
local function applyPerfectSync(physical_pages)
        ...
        -- Mevcut pagemap'i al (Güvenli Erişim)
        ...
        -- PocketBook ve diğer cihazlar için optimize edilmiş en güvenli arayüz güncellemesi
        if pagemap then
            ...
            -- SİSTEMİ ZORLAMADAN GÜNCELLEME (Hata korumalı)
            local Event = require("ui/event")
            local UIManager = require("ui/uimanager")
            UIManager:broadcastEvent(Event:new("PagemapUpdated"))
        end
